				...
				<Flex direction="column" gapY="4">
					...
					<Flex direction="column" gapY="2">
						<Text as="p" className='font-oxanium'>
							...
							with a deep passion for App Development, both Web and Mobile. For over three years, I have
							been continuously learning and honing my skills in building intuitive and efficient
							applications.
						</Text>
						<Text as="p" className='font-oxanium'>
							Beyond coding, I have a strong curiosity for emerging technologies and enjoy exploring new
							fields. Currently, I am expanding my knowledge in{' '}
							<Text color="blue" className="font-medium">
								Machine Learning
							</Text>
							, driven by my enthusiasm for innovation and problem-solving. I believe that technology has
							the power to create meaningful solutions, and I’m always eager to learn, experiment, and
							grow as a developer.
						</Text>
					</Flex>
